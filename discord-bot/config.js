...
// Secret d'écriture Firebase. Optionnel tant que les règles de database.rules.json
// ne sont pas appliquées ; obligatoire ensuite, sinon toutes les écritures de
// betting/ (soldes, paris) seront refusées.
const FIREBASE_AUTH_SECRET = process.env.FIREBASE_AUTH_SECRET || null;
...
module.exports = { FIREBASE_URL, FIREBASE_AUTH_SECRET, ROSTER_URL, DISCORD_TOKEN, DISCORD_CLIENT_ID, DISCORD_GUILD_ID, DISCORD_LOG_CHANNEL_ID };
