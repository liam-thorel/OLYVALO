...
const SITE_VERSION = '20260810-firebase-connection-fix';
...
import { initTheme, initTilt, initParallax, initSearch, initKeyboard, updateFavCount, initHeroParticles, initWheelLogos, initLivePage, initHistoryPage } from './interactions.js?v=20260810-firebase-connection-fix';
import { storage } from './storage.js';
import { avatarLayersHTML } from './avatars.mjs';
import { initAdminPage } from './admin.mjs?v=20260810-firebase-connection-fix';
import { initBettingPage } from './betting-page.mjs';
import { getGameMode, initGameMode } from './game-mode.mjs?v=20260806-lol-mode';
import { initLolHistoryPage, initLolLivePage } from './lol-pages.mjs?v=20260810-firebase-connection-fix';
