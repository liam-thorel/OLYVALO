...
assert.match(liveIndex, /historyIndex\/valorant/, 'Valorant history must publish its progressive timeline index');
assert.match(read('lol-watcher.js'), /historyIndex\/lol/, 'LoL history must publish its progressive timeline index');
